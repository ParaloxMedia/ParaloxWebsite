...
const PULSE_POSTS = {
  'news-paralox-1year-anniversary-2026': { title: 'One Year of Paralox Media. Small Team. Big Vision. Endless Ambition. | Paralox Pulse',               description: 'We celebrated 1 year of Paralox Media at Co-Spaces Bambalapitiya — a milestone built from sleepless nights, bold ambitions, real partnerships, and a team that showed up every single day. Year 1 done. Now it\'s time to build bigger.',                                image: '/images/events/paralox1/703979204_1009247621601508_50292779292331069_n.jpg' },
  ...
  'news-mullenlowe-partnership-2026': { title: 'Paralox Media Onboarded with MullenLowe Sri Lanka as Production Partner for LoweDigital | Paralox Pulse', description: 'Paralox Media has officially partnered with MullenLowe Sri Lanka, working directly with LoweDigital on production.',                                                                                          image: null },
