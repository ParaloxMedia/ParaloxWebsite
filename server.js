...
const PULSE_POSTS = {
  'upcoming-anniversary-2026':         { title: 'Paralox Media Turns 1 — Anniversary Celebration & Get Together | Paralox Pulse', description: 'One year of building, growing, and delivering AI-powered digital solutions. Today we celebrate with our team, clients, and everyone who has been part of the journey.' },
  'upcoming-smm-tool-launch-2026':     { title: 'SMM Automation Tool — Official Launch | Paralox Pulse', description: 'We\'re launching our in-house SMM Automation Tool — built to simplify the client-agency relationship and deliver consistently better social media output.' },
  'upcoming-genai-masterclass-2026':   { title: 'Generative AI Masterclass — For Our Team & You | Paralox Pulse', description: 'A focused Gen AI masterclass open to the Paralox team and select external attendees. Covering prompt engineering, AI content creation, AI video, and real-world applications.' },
  'past-rotaract-ai-workshop-2026':    { title: 'AI & Automation: Career Impact Workshop — Rotaract Club of Colombo Mid Town | Paralox Pulse', description: 'Paralox Media CEO Abubakker Bakthathi took the stage as a featured speaker at the Rotaract Club of Colombo Mid Town\'s AI & Automation: Career Impact Workshop.' },
  'news-zahira-silver-sponsor-2025':   { title: 'Paralox Media — Silver Sponsor at Zahira College\'s 133rd Anniversary Cricket Tournament | Paralox Pulse', description: 'Paralox Media proudly stepped in as Silver Sponsor for the Zahira College Group of 2010 Cricket Tournament, held as part of the institution\'s landmark 133rd Anniversary celebrations.' },
  'news-wpp-media-partnership-2025':   { title: 'Paralox Media Partners with WPP Media Sri Lanka | Paralox Pulse', description: 'Paralox Media has partnered with WPP Media Sri Lanka — the world\'s largest advertising group. We are now producing AI-generated creatives for WPP Media Sri Lanka\'s campaigns.' },
  'news-mullenlowe-partnership-2026':  { title: 'Paralox Media Onboarded with MullenLowe Sri Lanka — Production Partner for LoweDigital | Paralox Pulse', description: 'Paralox Media has officially partnered with MullenLowe Sri Lanka. We are now working directly with their digital arm, LoweDigital, primarily handling production.' },
  'news-keells-maliban-onboard-2026':  { title: 'Welcoming Keells, Maliban & More to the Paralox Family | Paralox Pulse', description: 'Paralox Media announces new partnerships with iconic Sri Lankan brands — Keells, Maliban, Edinburgh, Yevan, Ritsbury, Kreset, and Masterchef Sri Lanka.' },
  'insight-ai-marketing-2026':         { title: '5 Ways AI Is Transforming Digital Marketing in 2026 | Paralox Labs', description: 'From hyper-personalised ad copy to real-time campaign optimisation — here\'s how AI is reshaping what\'s possible for brands of every size.' },
  'insight-ai-agents-2026':            { title: 'How AI Agents Are Replacing Traditional Customer Support | Paralox Labs', description: 'One of our clients reduced response times by 60% and cut support costs by 40% after deploying a custom AI agent. Here\'s how it works.' },
  'news-global-expansion-2026':        { title: 'Paralox Media Now Serving Clients in 7+ Countries | Paralox Pulse', description: 'From Sri Lanka to Singapore, UAE to the UK — our global footprint continues to grow as demand for AI-powered digital solutions rises worldwide.' },
};
