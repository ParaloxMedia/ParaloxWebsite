...
const VACANCIES = [
  {
    ...
    category: 'Creative',
    badge: 'Open',
    summary: 'Paralox Media is looking for a creative and detail-oriented Video Editor to join our growing team.',
    requirements: [
      'Strong experience with DaVinci Resolve, After Effects, and Premiere Pro',
      'Solid skills in 2D animation and motion graphics',
      'Good sense of storytelling, pacing, and composition',
      'Expertise in professional color grading',
      'Ability to create high-quality AI-driven creative content',
    ],
    color: '#8B52F7',
  ...
  },
  {
    ...
    category: 'Creative',
    badge: 'Open',
    summary: 'Paralox Media is looking for a creative Graphic Designer to bring ideas to life across digital platforms.',
    requirements: [
      'Strong skills in Adobe Photoshop, Illustrator, and Canva',
      'Good understanding of branding, layout, and typography',
      'Ability to create social media creatives, ads, and marketing materials',
      'Strong attention to detail and visual consistency',
      'AI-assisted design workflow experience is a plus',
    ],
    color: '#60EFFF',
